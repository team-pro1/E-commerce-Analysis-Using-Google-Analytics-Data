...
1-1) Acquisition를 위한 테이블 생성하여 시각화

1-2) 코호트 분석

1-3) ARPU / ARPPU 분석

1-4) 브라우저 / 운영체제 / 기기별 유입 Top20

1-5) 기기 유형별 Acquisition 품질 비교 (모바일 vs 데스크탑 vs 태블릿)

1-6) 고객별 누적 매출 분포 (Pareto)

1-7) 브라우저별 Revenue 비교

1-8) 국가별 Revenue Top10 분석
...
4-4) 전환 유저와 이탈 유저의 사용자 행동 분석

4-5) 이탈한 고객의 재방문 후 전환율
