...
| <img src="image-1.png" width="100"> | <img src="image-3.png" width="100"> | <img src="image-2.png" width="100"> | <img src="image-4.png" width="100"> |
|------------------------------------|------------------------------------|------------------------------------|------------------------------------|
| 김혜원                             | 변해민                             | 양원선                             | 전수연                             |
...
| 팀원    | 소감                                                                                                                                                                                                                       |
|--------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 김혜원 | 이번 프로젝트를 통해 사용자 행동 데이터를 직접 다루고, BigQuery를 연결해 쿼리를 작성하며 결과를 도출하는 과정을 경험할 수 있었습니다.<br> 단순히 데이터를 불러오는 수준을 넘어 실제로 분석 흐름을 설계하고 시각화까지 이어가면서, 이커머스 데이터 구조와 해석 방식에 대한 이해도를 크게 높일 수 있었습니다. <br>데이터 분석 전 과정을 직접 수행해 본 값진 경험이었다고 생각합니다. |
